...
if (isEmbedded) {
  discordSdk = new DiscordSDK(import.meta.env.VITE_DISCORD_CLIENT_ID, {disableConsoleLogOverride: true});
  patchUrlMappings([
  ...
  discordSdk = new DiscordSDKMock(import.meta.env.VITE_DISCORD_CLIENT_ID, null, null);
  // @ts-expect-error
